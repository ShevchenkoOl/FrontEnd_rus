...
\<details\>
\<summary\>\<strong\>2. Тип напитка и цена:\</strong\> Есть переменная \<code\>drink = "coffee"\</code\>. Выведите через \<code\>switch\</code\> цену: чай — 35, кофе — 70, вода — 25. Иначе "Напитка нет". 👉 \<b\>Посмотреть решение\</b\>\</summary\>
...
\<details\>
\<summary\>\<strong\>3. Определение сезона:\</strong\> Решите задачу определения времени года по номеру месяца через \<code\>switch\</code\> с объединением \<code\>case\</code\>. 👉 \<b\>Посмотреть решение\</b\>\</summary\>
...
\<details\>
\<summary\>\<strong\>4. Меню команд (с учетом регистра):\</strong\> Пользователь вводит команду (start, stop, exit, help). Очистите ввод от пробелов и приведите к нижнему регистру, а затем обработайте через \<code\>switch\</code\>. 👉 \<b\>Посмотреть решение\</b\>\</summary\>
...
\<details\>
\<summary\>\<strong\>5. Вывести числа от 1 до 100:\</strong\> Выведите все числа от 1 до 100 двумя способами (через \<code\>for\</code\> и через \<code\>while\</code\>). 👉 \<b\>Посмотреть решение\</b\>\</summary\>
...
\<details\>
\<summary\>\<strong\>6. Вывести нечётные числа от 1 до 20:\</strong\> Используя цикл, выведите в консоль только нечетные числа из этого диапазона. 👉 \<b\>Посмотреть решение\</b\>\</summary\>
...
\<details\>
\<summary\>\<strong\>7. Сумма чисел от 1 до N:\</strong\> Пользователь вводит число N. Найдите сумму всех чисел от 1 до N включительно с помощью цикла. 👉 \<b\>Посмотреть решение\</b\>\</summary\>
...
\<details\>
\<summary\>\<strong\>8. Факториал числа N:\</strong\> Найдите факториал числа (например, 5\! = 1 \* 2 \* 3 \* 4 \* 5 = 120). 👉 \<b\>Посмотреть решение\</b\>\</summary\>
...
\<details\>
\<summary\>\<strong\>9. Таблица умножения числа 7:\</strong\> Выведите в консоль таблицу умножения для семерки от 1 до 10. 👉 \<b\>Посмотреть решение\</b\>\</summary\>
...
\<details\>
\<summary\>\<strong\>10. Ввод до отрицательного числа:\</strong\> Просите пользователя вводить числа через prompt. Остановите цикл, если введено отрицательное число или не-число (текст). 👉 \<b\>Посмотреть решение\</b\>\</summary\>
...
\<details\>
\<summary\>\<strong\>11. Игра "Угадай число":\</strong\> Компьютер загадывает число от 1 до 10. Пользователь вводит числа через prompt. Программа подсказывает "Больше" или "Меньше", пока число не будет угадано. 👉 \<b\>Посмотреть решение\</b\>\</summary\>
...
\<details\>
\<summary\>\<strong\>12. Запрос пароля:\</strong\> Просите пользователя вводить пароль, пока он не введет "admin123". 👉 \<b\>Посмотреть решение\</b\>\</summary\>
...
\<details\>
\<summary\>\<strong\>13. Вывод каждой буквы:\</strong\> С помощью цикла \<code\>for\</code\> выведите каждую букву строки "JavaScript" в консоль с новой строки. 👉 \<b\>Посмотреть решение\</b\>\</summary\>
...
\<details\>
\<summary\>\<strong\>14. Подсчет гласных:\</strong\> Посчитайте, сколько гласных букв в слове "JavaScript". Используйте метод \<code\>.includes()\</code\>. 👉 \<b\>Посмотреть решение\</b\>\</summary\>
...
\<details\>
\<summary\>\<strong\>15. Проверка ввода (1-5):\</strong\> Просите пользователя ввести число от 1 до 5. Если он ввел число больше 5 — спрашивайте снова. 👉 \<b\>Посмотреть решение\</b\>\</summary\>
...
\<details\>
\<summary\>\<strong\>16\*. Сложная сумма ряда:\</strong\> Пользователь вводит \<code\>n\</code\>. Вычислите ряд: 1/1 + 1/4 + 1/7 + ... (знаменатель каждый шаг +3). Округлите итог до 2 знаков. 👉 \<b\>Посмотреть решение\</b\>\</summary\>
...
\<details\>
\<summary\>\<strong\>17\*. Проверка на панграмму:\</strong\> Напишите код, который проверяет, содержит ли заданное предложение все буквы английского алфавита хотя бы один раз. 👉 \<b\>Посмотреть решение\</b\>\</summary\>
